type SensorType = "energy" | "vibration" | string;
...
export function SensorIcon({ type, color }: SensorIconProps) {
  ...
  const sensorType: Record<SensorType, JSX.Element> = {
    energy: <EnergyIcon color={color} />,
    vibration: (
      <div
        style={{
          background: color,
  ...
  return sensorType[type] || sensorType.vibration;
}
